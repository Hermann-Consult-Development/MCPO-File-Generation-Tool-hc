...
DOCS_TEMPLATE_PATH = ((DOCS_TEMPLATE_DIR_ENV or os.path.join(DEFAULT_PATH_ENV, "../docker/mcpo/templates")).rstrip("/"))
...
if DOCS_TEMPLATE_PATH and os.path.exists(DOCS_TEMPLATE_PATH):
    ...
    XLSX_TEMPLATE_PATH = os.path.join(DEFAULT_PATH_ENV, "../docker/mcpo/templates", "Default_Template.xlsx")
